                ...
                <div className="content">
                    ...
                    <section className="person-boxes">
                        ...
                        <div className="person-box">
                            ...
                            <div className="box-bio">
                                <h2 className="bio-name">Victoire Durand</h2>
                                <p className="bio-position">Head of Private Banking</p>
                            </div>
                        ...
                        <div className="person-box">
                            ...
                            <div className="box-bio">
                                <h2 className="bio-name">John Connely</h2>
                        ...
                        <div className="person-box">
                            ...
                            <div className="box-bio">
                                <h2 className="bio-name">Gerart Rotchet</h2>
